...
const EditPassport = () => {
  ...
  const handleChange = (event) => {
    if (event.target.name === 'passFile') {
      setPassportData(
        {
          ...passportData,
          passFile: event.target.files[0]
        }
      )
    } else {
      ...
      if (flag) {
        ...
        try {
          ...
          if(!checkpass){
            ...
            const res = await axiosprivate.put(`/upload/passport/${localStorage.getItem('userid')}/${checkpass.data[0]._id}`, formData, config)
            res && alert("Passport Information updated successfully!")
            window.location.href = '/passport'
          }
        ...
        <Table>
          <tbody>
            ...
            <Row>
              ...
              <TableDataII><FName type="text" name="name" value={passportData.name} onChange={handleChange}></FName></TableDataII>
            </Row>

            <Row>
              <TableDataI>Date Of Birth :</TableDataI>
              <TableDataII><DOB type="date" name="dob" value={passportData.dob} onChange={handleChange}></DOB></TableDataII>
            </Row>

            <Row>
              <TableDataI>Passport Number :</TableDataI>
              <TableDataII><PNumber type="text" name="passportNumber" value={passportData.passportNumber} onChange={handleChange}></PNumber></TableDataII>
            </Row>

            <Row>
              <TableDataI>Issue Date :</TableDataI>
              <TableDataII><IDate type="date" name="issueDate" value={passportData.issueDate} onChange={handleChange} /></TableDataII>
            </Row>

            <Row>
              <TableDataI>Expiry Date :</TableDataI>
              <TableDataII><EDate type="date" name="expiryDate" value={passportData.expiryDate} onChange={handleChange} /></TableDataII>
            </Row>
            ...
            <Row>
              ...
              <TableDataII>
                <PFile type="file" name="passFile" onChange={handleChange} />
              </TableDataII>
            </Row>

          </tbody>
        </Table>
        <Submit onClick={handlePassportSubmit}>Upload</Submit>
      </Wrapper>
      <Footer/>
    </Container>
  )
